...
const observatories = Dict(
    "mgio"=>Observatory("Mount Graham International Observatory",
...
"""
const planets = Dict(
    "mercury"=>Planet("mercury", 2439.7e3, 2439.7e3, 2439.7e3, 3.3011e23,
    ...
    "mars"=>Planet("mars", 3389.5e3, 3396.2e3, 3376.2e3, 6.4169e23,
                   0.09339410, 1.52371034AU, 686.98*86400,
                   1.84969142, 49.55953891, -23.94362959, -4.55343205),
    "jupiter"=>Planet("jupiter", 69911e3, 71492e3, 66854e3, 1898.19e24,
                      0.04838624, 5.20288700AU, 4332.589*86400,
    ...
    "pluto"=>Planet("pluto", 1187e3, 1187e3, 1187e3, 0.01303e24,
                    0.24882730, 39.48211675AU, 90560.0*86400,
